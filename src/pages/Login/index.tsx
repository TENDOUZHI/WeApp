    ...
    return (
        <div className="login">
            ...
            <div className="login-right">
                <div className="login-right-card" ref={card}>
                    <div className="login-right-card-title" >
                        <span className="login-right-card-title-main" ref={titleMain}>{title}您的账户</span>
                        <div className="login-right-card-title-sub" ref={titleSub}>
                            <span className="login-right-card-title-sub-tip">没有账号？</span>
                            <span className="login-right-card-title-sub-link" onClick={switchCard}>{linkMsg}</span>
                        </div>
                    </div>
                    <div className="login-right-card-input" ref={inputFrame}>
                        <div className="login-right-card-input-account">
                        ...
                        <div className="login-right-card-input-username">
                            <div className="input-form">
                                ...
                                <div className="input-form-reg">
                                    ...
                                    <button className="input-form-reg-register" ref={register}>注册</button>
                                </div>
                            </div>
